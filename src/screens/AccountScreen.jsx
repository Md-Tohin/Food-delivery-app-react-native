    ...
    const loadUser = async () => {
        ...
        try {
            ...
            const res = await axios.get(
                `${ApiContents.BACKEND_API.BASE_APP_URL}${ApiContents.BACKEND_API.USER}/get-user-details`,
        ...
        <View style={styles.container}>
            ...
            <View style={styles.profileHeaderContainer}>
                ...
                <View style={styles.profileTextContainer}>
                    <Text style={styles.nameText}>{user?.name ?? "Md. Tohin"}</Text>
                    <Text style={styles.emailText}>{user?.email ?? "mdtohin8585@gmail.com"}</Text>
                </View>
            </View>

            <View style={styles.menuContainer}>
                <TouchableOpacity style={styles.menuItem} activeOpacity={0.8} onPress={() => navigation.navigate("orders")}>
