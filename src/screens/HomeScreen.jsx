...
const HomeScreen = ({navigation}) => {
  ...
  const [restaurants, setRetaurants] = useState(null);
    ...
    <View style={styles.container}>
      ...
      <View style={styles.headerContainer}>
        <View style={styles.locationContainer}>
          ...
          <MaterialIcons name="keyboard-arrow-down" size={16} color={Colors.DEFAULT_WHITE} />
          <Feather name="bell" size={24} color={Colors.DEFAULT_WHITE} style={{position: 'absolute', right: 0}} />
